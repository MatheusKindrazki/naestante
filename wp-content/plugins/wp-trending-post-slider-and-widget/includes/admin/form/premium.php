...
<div class="wrap">
	...
	<div class="wprps-notice">
		<a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=27724&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>
	<style>
	...
	<table class="wpos-plugin-pricing-table">
		...
		<tfoot>
			<tr>
				<th></th>
				<td></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=27724&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade Now</a></td>
			</tr>
		</tfoot>
